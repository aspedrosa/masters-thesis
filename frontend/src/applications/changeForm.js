import { SimpleForm, TextInput, ReferenceInput, SelectInput } from 'react-admin';
...
const ChangeForm = () => (
    <SimpleForm>
        ...
        <div style={{ width: "100%" }}>
            ...
            the <a href="https://docs.python-requests.org/en/latest/api/#requests.request" target="_blank"> request </a> function of the requests python package.
            <br/>
            ...
            <ul>
                ...
                <li>filtered_data: <a href="https://pandas.pydata.org/docs/reference/api/pandas.DataFrame.html" target="_blank">pandas dataframe</a></li>
            </ul>
            <br/>
