...
FileSytem Source connector
FilePulse Source connector
JDBC Source connector

\begin{itemize}
    \item to avoid using kafka just for healthchecks and because kafka contains kafka connect source connectors
    \item ja que vamos usar o kafka, este tem algumas appllicação ja devenvolvida que tiram dados de uma source e metem mensagem no kafka
    \item enviar todos os dados numa mensagem não é fiavel
...
\section{Network Manager}  % TODO change name
\begin{itemize}
