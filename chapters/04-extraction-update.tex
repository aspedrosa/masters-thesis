...
There is also a Kafka Streams library to perform processing on streams of data on top of Kafka.
...
Such group of components will be called Metadata Manager, which will perform operation on top of Kakfa
