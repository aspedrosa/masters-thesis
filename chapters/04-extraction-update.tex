...
%    \item 2 threads: one reads uploads and creates streams of data, another closes streams once all data was transfered
%\end{itemize}
...
\begin{itemize}
    ...
    \item since data was filtered, small data is in memory now
\end{itemize}
...
\begin{itemize}
    ...
    \item manage the whole thing. talks to the other components using kafka management topics
