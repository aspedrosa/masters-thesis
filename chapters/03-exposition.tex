...
To render this question type, a third-party widget called Tabulator\footnote{http://tabulator.info/} was being used.
...
The MONTRA framework will then put the provided objects on the configuration array that the Tabulator widgets expect, adding the configuration for the date column.
...
This type of question allows to reuse the same choices for several 
3 things:
choices, columns
questions/things, rows
answers types, widget (choice, multiple-choice, text)
