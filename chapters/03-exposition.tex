...
\textit{TODO têm de existir pelo menos mais um endpoint para permitir atualizar perguntas pontualmente, não tendo a necessidade de apresentar os dados de todas as outras perguntas do mesmo question set como é o caso dos novos /submission/save endpoinsts. portanto o argumento aqui deve ser que os dois tipos de endpoints usam codigo diferente para fazer validação}
...
\textit{TODO pode ser interessante ter aqui um paragrafo e uma citação para o que é e o que custuma acontercer num processo de refactoring}
...
\textit{TODO vou ter de mencionar também os answers/<question-slug> endpoints pois permitem atualizar respostas sem ter de apresentar as respostas as restantes perguntas do mesmo question set. o que é necessario, tanto para manter o api para os utilizadores como para as aplicações do proximo capitulo}
...
\textit{TODO afinal yaml não é muito indicado pois "asdf:asdf" é considerado um escalar e "asdf: asdf" já é considerado um entrada key:value valida. Acho que estar estar a falhar a importação e dizer ao utilizador "mete um espaço" não é muito nice}
