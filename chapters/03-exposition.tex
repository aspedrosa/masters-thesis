...
% choice tabular: rows and columns information is stored on the metadata field of the question model
% open multiple: columns information is stored on the metadata field of the question model
