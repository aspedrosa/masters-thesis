...
To the administrator is given the ability to determine which data fields can be used for discovery and/or to be displayed as results, and also which records are allowed to be used for discovery.
