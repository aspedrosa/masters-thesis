...
%\hline
%GAAIN\cite{gaain} & {\color{red} \xmark} & {\color{red} \xmark} (Any registered user) & {\color{red} \xmark} \\
\hline
...
Light footprint. The GAAIN DPC at each data partner site does not interfere with or
