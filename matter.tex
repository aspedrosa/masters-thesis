...
% Eg. Fig 1a, Fig 1b
\usepackage[hypcap,hang,small,bf]{caption}
%\let\tion\undefined
...
\bibliography{bib/02-background.bib, bib/03-exposition.bib, bib/04-extraction-update.bib}
...
\chapter{Agent and Metadata Manager Data flow}
\label{appendix:a}
...
\begin{figure}[H]
    \center
    \includegraphics[width=.58\textwidth]{figs/04-extraction-update/all}
    \caption{The architecture of the entire Metadata manager and its interaction with the agent.}
\end{figure}
...
\begin{figure}[H]
    \center
    \includegraphics[width=\textwidth]{figs/admin-portal/login}
    \caption{Login page.}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Show page of a database.}
